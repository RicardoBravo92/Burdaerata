...
function header() {
  return (
    <header className='sticky top-0 z-50 flex justify-between items-center p-4 gap-4 h-16 bg-sidebar  text-sidebar-foreground shadow-sm shrink-0'>
      <h1 className='text-3xl md:text-xl font-bold   my-2 text-start'>
        Burdaerata
      </h1>
